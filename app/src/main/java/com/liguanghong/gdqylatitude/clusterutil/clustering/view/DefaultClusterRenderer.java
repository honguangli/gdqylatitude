...
package com.liguanghong.gdqylatitude.clusterutil.clustering.view;
...
import com.liguanghong.gdqylatitude.clusterutil.MarkerManager;
...
import com.liguanghong.gdqylatitude.clusterutil.projection.Point;
import com.liguanghong.gdqylatitude.clusterutil.projection.SphericalMercatorProjection;
import com.liguanghong.gdqylatitude.clusterutil.ui.IconGenerator;
...
import static com.liguanghong.gdqylatitude.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.liguanghong.gdqylatitude.clusterutil.clustering.view.ClusterRenderer<T> {
   ...
   /* private LayerDrawable makeClusterBackground() {
    ...
    //    outline.getPaint().setColor(0x80ff00cc); // Transparent white.
    ...
    /*private com.liguanghong.gdqylatitude.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.liguanghong.gdqylatitude.clusterutil.ui.SquareTextView squareTextView =
                new com.liguanghong.gdqylatitude.clusterutil.ui.SquareTextView(context);
