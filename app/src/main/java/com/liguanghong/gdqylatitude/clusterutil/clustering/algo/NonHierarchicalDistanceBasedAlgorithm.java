...
package com.liguanghong.gdqylatitude.clusterutil.clustering.algo;
...
import com.liguanghong.gdqylatitude.clusterutil.projection.Bounds;
...
import com.liguanghong.gdqylatitude.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.liguanghong.gdqylatitude.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.liguanghong.gdqylatitude.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.liguanghong.gdqylatitude.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.liguanghong.gdqylatitude.clusterutil.clustering.algo
