...
public class SelectPhotoLoaderUtil {
    private static SelectPhotoLoaderUtil mInStance;
    ...
    public SelectPhotoLoaderUtil(int threadCount, Type type) {
    ...
    public  static  SelectPhotoLoaderUtil getInStance(){
        if (mInStance==null){
            synchronized (SelectPhotoLoaderUtil.class){
                if (mInStance==null){
                    mInStance=new SelectPhotoLoaderUtil(DEAFULT_THREAD_COUNT, Type.LIFO);
                }
            }
        }
        return  mInStance;
    }
    public  static  SelectPhotoLoaderUtil getInStance(int threadCount,Type type){
        if (mInStance==null){
            synchronized (SelectPhotoLoaderUtil.class){
                if (mInStance==null){
                    mInStance=new SelectPhotoLoaderUtil(threadCount,type);
                }
            }
        }
        return  mInStance;
