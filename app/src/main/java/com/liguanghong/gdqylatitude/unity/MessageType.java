...
public class MessageType {
	...
	//通知类消息 -- 群聊通知类
	public static final Integer GROUPAPPLY = 18;			//群聊加入申请
	public static final Integer GROUPDENIED = 19;		//群聊加入申请被拒绝
	public static final Integer GROUPAGREED = 20;		//群聊加入申请被同意
	public static final Integer GROUPINVITE = 21;		//群聊邀请
	public static final Integer GROUPINVITEDENIED = 22;	//群聊邀请被拒绝
	public static final Integer GROUPINVITEAGREED = 23;	//群聊邀请被同意
